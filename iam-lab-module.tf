...
module "network-security-eng-admin" {
  ...
  members              = ["group:dc-amex-foundations@google.com"]
  // members              = ["group:PRC-AXP-BAE2-AppAdminGCP-NetSec@amex.com", "group:PRC-AXP-BAE2-AppAdminGCPNetSecOp@amex.com"]
  permissions          = []
}
...
module "network-admin" {
  ...
  base_roles           = ["roles/compute.networkAdmin", "roles/compute.xpnAdmin", "roles/resourcemanager.folderViewer"]
  members              = ["group:dc-amex-foundations@google.com"]
...
module "cloudsolutions-poweruser" {
  ...
  members              = ["group:dc-amex-foundations@google.com"]
  // members              = ["group:PRC-AXP-PUE2-AppAdminGCP-Dev-Eng@amex.com]
  permissions          = []
}
...
module "cloudqe-poweruser" {
  ...
  base_roles           = ["roles/resourcemanager.projectCreator", "roles/compute.networkUser", "roles/bigquery.dataOwner", "roles/bigquery.user", "roles/dataproc.admin", "roles/storage.admin", "roles/logging.logWriter", "roles/logging.privateLogViewer"]
  members              = ["group:dc-amex-foundations@google.com"]
  // members              = ["group:PRC-AXP-PUE2-AppAdminGCP-TESTEng@amex.com]
  permissions          = []
}