...
3. **module prj-lab-vpc** creates lab vpc(sandbox) project
...
|------|-------------|------|---------|:--------:|
|  organization | oraganization name for creating project | `string` | "wf" | yes |
|  geo | country name for creating project | `string` | "us" | yes |
|  prod-env | environment name for creating project name | `string` | "prod" | yes |
|  non-prod-env | environment name for creating project name | `string`| "non-prod" | yes  |
|  sandbox-env | environment name for creating project name| `string` | n/a | yes |
|  networking-appID-system | appID-system name for creating project name| `string` | n/a | yes |
